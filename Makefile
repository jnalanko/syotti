...
syotti:
	g++ $(SRC_DIR)/CLI.cpp $(SRC_DIR)/examine.cpp $(SRC_DIR)/fill_gaps.cpp $(SRC_DIR)/greedy.cpp $(SRC_DIR)/random_subset.cpp $(SRC_DIR)/FM_index.cpp $(SRC_DIR)/build_FM_index.cpp $(SRC_DIR)/input_reading.cpp -O3 -o $(BINARY_DIR)/syotti -g -Wall -Wno-sign-compare $(LIBPATHS) $(INCLUDEPATHS) $(LIBS)
